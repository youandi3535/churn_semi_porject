...
function renderBarLine(canvasId, data) {
  ...
  mountChart(canvasId, canvasId, {
    ...
    options: {
      ...
      plugins:{
        legend:{labels:{color:TICK_COLOR, font:{size:13}}},
      ...
      scales:{
        x: { grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR},
             title:{display:true, text:data.x_label||'', color:TICK_COLOR, font:{size:15}} },
        y: { position:'left', min:0, max:Math.max(100,...data.values)+5,
             grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
             title:{display:true, text:'해지율 (%)', color:c, font:{size:15,weight:'700'}} },
...
function renderLine(canvasId, data) {
  ...
  mountChart(canvasId, canvasId, {
    ...
    options:{
      responsive:true, maintainAspectRatio:false,
      animation:{duration:ANIM_MS, easing:'easeOutQuart'},
      plugins:{legend:{labels:{color:TICK_COLOR, font:{size:13}}}},
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR},
            title:{display:true, text:data.x_label||'', color:TICK_COLOR, font:{size:15}} },
    ...
    options:{
      ...
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
            title:{display:true, text:'해지율 (%)', color:c, font:{size:15}} },
  ...
  mountChart(canvasId, canvasId, {
    ...
    options:{
      ...
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR} },
        y:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
            title:{display:true, text:'해지율 (%)', color:c, font:{size:15,weight:'700'}}, min:0 },
      },
    },
  });
}
...
function renderBar(canvasId, data) {
  ...
  mountChart(canvasId, canvasId, {
    ...
    options:{
      responsive:true, maintainAspectRatio:false,
      animation:{duration:ANIM_MS, easing:'easeOutQuart'},
      plugins:{legend:{labels:{color:TICK_COLOR, font:{size:15}}}},
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR},
            title:{display:true, text:data.x_label||'', color:TICK_COLOR, font:{size:15}} },
        y:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
    ...
    options:{
      ...
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR},
            title:{display:true, text:data.x_label||'', color:TICK_COLOR, font:{size:15}} },
        y:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
            title:{display:true, text:'해지율 (%)', color:TICK_COLOR, font:{size:15}} },
      },
    },
  });
}
