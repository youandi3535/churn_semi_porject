...
#↑해석:변수= 1. 현재 실행 중인 파이썬 파일(insert.py)의 경로 /2.절대경로로 확정 /3.(insert.py파일 기준으로) 한 단계 위 폴더 /4.한단계 위 폴더로  (점 기준으로 나눠보면)
...
#=======================================================================================
#=======================================================================================
# 참고) [df->DB] 주피터 노트북에서 - 데이터프레임 상태에서 -> 오라클 DB에 넣기 & CSV파일 만들기
# from pathlib import Path-----
# from sqlalchemy import create_engine, String, Integer, Numeric
# from dotenv import load_dotenv
# import pandas as pd
