    ...
    options: {
      ...
      scales:{
        x: { grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR},
             title:{display:true, text:data.x_label||'', color:TICK_COLOR, font:{size:14}} },
        y: { position:'left', min:0, max:Math.max(100,...data.values)+5,
             grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
             title:{display:true, text:'해지율 (%)', color:c, font:{size:14,weight:'700'}} },
        y2:{ position:'right', grid:{drawOnChartArea:false},
             ticks:{color:'#a5b4fc', callback:v=>v.toLocaleString()+'명'},
             title:{display:true, text:'고객 수', color:'#818cf8', font:{size:14}} },
      },
    },
  });
}
    ...
    options:{
      ...
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
            title:{display:true, text:'해지율 (%)', color:c, font:{size:14}} },
  ...
  mountChart(canvasId, canvasId, {
    ...
    options:{
      ...
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR} },
        y:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
            title:{display:true, text:'해지율 (%)', color:c, font:{size:14,weight:'700'}}, min:0 },
      },
    },
  });
}
    ...
    options:{
      ...
      scales:{
        x:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR},
            title:{display:true, text:data.x_label||'', color:TICK_COLOR, font:{size:14}} },
        y:{ grid:{color:GRID_COLOR}, ticks:{color:TICK_COLOR, callback:v=>v+'%'},
            title:{display:true, text:'해지율 (%)', color:TICK_COLOR, font:{size:14}} },
      },
    },
  });
}
