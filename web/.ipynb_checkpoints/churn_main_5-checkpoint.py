...
print("🔥 churn_main_5.py 실행 중 🔥")

# ============================================================
# 📁 churn_main_5.py
#
# ★ 이전(churn_main_3)과 달라진 점 ★   -> 내용 수정하기
#   1. get_df1~6 모두 grade 파라미터 받음
#      → ABCD 버튼 클릭 시 등급별로 다른 highlight 인덱스 반환
#   2. get_all_data() 에서 grade를 각 함수에 전달
#   3. ai_service.py 는 그대로 사용 (변경 없음)
#
# ★ highlight_map 원리 ★
...
@app.route("/")
def index():
    return render_template("dashboard_07.html")
